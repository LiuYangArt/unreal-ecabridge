...
public class ECABridge : ModuleRules
{
	...
	public ECABridge(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		// Force Latest include-order so transitive engine-plugin editor headers
		// (notably StateTreeEditorModule on 5.7) don't trigger C4668
		// warning-as-error storms where their include chain doesn't carry the
		// UE_ENABLE_INCLUDE_ORDER_DEPRECATED_IN_5_x defines.
